        ...
        {roomsDummyData.map((room) => (
          ...
          >
            <img
              ...
              className="max-h-64 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer py-4"
            />
            <div className="md:w-1/2 flex flex-col gap-2">
              <p className="text-gray-500 cursor-pointer">{room.hotel.city}</p>
              <p
                ...
                onChange={(checked, label) => {
                  setSelectedFilters((prev) => ({
                    ...
                    priceRange: checked
                      ...
                      : prev.priceRange.filter((item) => item !== range),
                  }));
                }}
              />
            ))}
